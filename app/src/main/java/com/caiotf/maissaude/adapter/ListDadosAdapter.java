...
public class ListDadosAdapter extends BaseAdapter{
        private Context mContext;
        private List<Dados> mDadosList;

        public ListDadosAdapter(Context mContext, List<Dados> mDadosList) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView tvNome = (TextView)v.findViewById(R.id.nomeId);
            TextView tvEndereco = (TextView)v.findViewById(R.id.enderecoId);
            TextView tvTelefone = (TextView)v.findViewById(R.id.telefoneId);
