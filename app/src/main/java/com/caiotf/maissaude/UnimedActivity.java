...
import com.caiotf.maissaude.adapter.ListDadosAdapterConvenio;
...
public class UnimedActivity extends AppCompatActivity {
    ...
    private ListDadosAdapterConvenio adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_unimed);
        ...
        //UNIMED
        String cUnimed = "select * from local l join  conveniolocal lc on l.codlocal = lc.codlocal join especialidades esp on esp.codesp = l.codesp where lc.codconv = 3 ORDER BY l.nome ASC";

        //Get product list in db when db exists
        mDadosList = mDBHelper.getListDados(cUnimed);
        //Init adapter
        adapter = new ListDadosAdapterConvenio (this, mDadosList);
