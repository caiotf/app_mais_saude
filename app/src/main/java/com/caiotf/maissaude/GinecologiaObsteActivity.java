...
public class GinecologiaObsteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ginecologia_obste);
        ...
        mDadosList = mDBHelper.getListDados(cGineco);
        //Init adapter
